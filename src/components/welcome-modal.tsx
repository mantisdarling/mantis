...
export default function WelcomeModal({ trigger }: WelcomeModalProps) {
  ...
  const defaultTrigger = (
    <Button
      variant="ghost"
      className="h-auto w-auto cursor-pointer rounded-2xl bg-card/30 p-3 shadow-lg backdrop-blur-lg hover:bg-card/60 focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 border border-border"
          ...
          >
            ...
            <DialogHeader className="relative flex flex-row items-start justify-between px-8 pt-8 pb-6">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="sticky top-0 right-0 cursor-pointer rounded-full bg-background p-2 text-foreground hover:bg-accent/80 hover:text-accent-foreground border border-border"
