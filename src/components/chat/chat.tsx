  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to bottom, rgba(10, 10, 10, 1) 0%, rgba(10, 10, 10, 0.95) 30%, rgba(10, 10, 10, 0.8) 50%, rgba(10, 10, 10, 0) 100%)',
        }}
      >
        <div
      ...
      <div className="container mx-auto flex h-full max-w-3xl flex-col">
        ...
        {/* Fixed Bottom Bar */}
        <div className="sticky bottom-0 bg-background/80 backdrop-blur-md px-2 pt-3 md:px-0 md:pb-4 border-t border-border mt-auto">
